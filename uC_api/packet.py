...
class Packet:
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                logging.error("Header " + str(unpacked[0]) + " is not a valid header, Packet:" + str(
                                    byte_array) + " " + str(unpacked[0]) + " " + str(unpacked[1]) + " " + str(unpacked[2]))
                                raise ValueError(
                                    "Header " + str(unpacked[0]) + " is not a valid header")
    ...
    def set_exec_time(self, time):
        ...
        if (time < 2**32 and time >= 0 and isinstance(time, int)):
            ...
            logging.error("exec_time "+str(time) +
    ...
    def to_bytearray(self):
        ...
        """
        logging.warning(
            "the method to_bytearray needs to be implemented by the child class")
...
class DataI2CPacket(Packet):
    ...
    def set_device_address(self, value):
        ...
        if (value < 2**7 and value >= 0 and isinstance(value, int)):
            ...
            logging.error("device_address "+str(value) +
    ...
    def set_register_address(self, value):
        ...
        if (value < 2**8 and value >= 0 and isinstance(value, int)):
            ...
            logging.error("register_address "+str(value) +
...
class PinPacket(Packet):
    ...
    def set_pin_id(self, pin_id):
        ...
        if (pin_id < 55 and pin_id >= 0 and isinstance(pin_id, int)):
            ...
            logging.error(
                "di "+str(pin_id)+" is not a valid unsigned integer of 1 byte + id < 55")
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                ...
                                logging.error(
                                    "source Header " + str(header) + " is not a valid header,")
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    logging.error(
                                        "source Sub Header " + str(header) + " is not a valid header,")
